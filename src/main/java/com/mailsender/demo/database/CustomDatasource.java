...
//                "\\; runscript from './src/main/resources/database/create-db.sql'");
        ...
        dataSource.setUrl("jdbc:h2:./target/dependency/database/EmbeddedDb;INIT=create schema if not exists ADDRESSEES" +
                "\\; runscript from './target/dependency/database/create-db.sql'");
        return dataSource;
    }
}
